...
class Diver:
    ...
    def search(self):
        print("search...")
        found = random.choice(treasure_1.rarity)
    ...
    def calculate_score(self):
        ...
        score.getHighScore()
        print(f"Current high score: {score.highScore}")
        if self.divers_score > int(score.highScore):
            score.newHighScore(str(score.self.divers_score))
            print(f"New high score: {score.self.divers_score}")
        else:
